...
ifdef::android[]
If you have purchased the app or subscription accidentally, or you are not satisfied with it, you can request a refund from Google Play.

Please note that refunds are handled by Google, and the aprs.fi developer cannot issue refunds directly. All sales and payments happen via Google Play, and the aprs.fi team does not have access to your payment information.
endif::android[]
