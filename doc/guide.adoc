...
Custom map overlays can be loaded on top of the APRS map from the *More* tab -> *Map Overlays*. Each overlay is a named GeoJSON or KML file loaded from a URL or imported from a local file.
